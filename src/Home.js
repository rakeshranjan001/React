...
class Home extends Component {
    render() {
        return (<header class="sans-serif">
        <div class="cover bg-left bg-center-l">
          <div class="bg-black-80 pb5 pb6-m pb7-l">
            ...
            <div class="tc-l mt4 mt5-m mt6-l ph3">
              ...
              <a class="f6 no-underline grow dib v-mid bg-blue white ba b--blue ph3 pv2 mb3" href="/">I want to Join</a>
              <span class="dib v-mid ph3 white-70 mb3">or</span>
              <a class="f6 no-underline grow dib v-mid white ba b--white ph3 pv2 mb3" href="/">See some examples</a>
            </div>
          </div>
        </div> 
      </header>
